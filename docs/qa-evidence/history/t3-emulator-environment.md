...
任务 t15，qa-release。下方原始盘点和启动结果是t15交接时的历史记录；当前状态以文末“t3实际复用与清理”及[独立QA报告](verification.md)为准。t15仅准备环境，不将准备结果当产品验证；t3随后使用完整集成APK。范围为本项目工具和文档，不修改系统功能、驱动、BIOS、真实手机、用户AVD、产品或主构建。
